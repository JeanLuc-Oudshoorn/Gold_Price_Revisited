...
with open('forecast_dictionary_rf_full.pkl', 'rb') as f:
    forecasts_rf = pickle.load(f)
...
f2019_rf = forecasts_rf['2019']

axs[0].plot(gold_data['2016-01-01':'2019-12-01'].index, gold_data.loc['2016-01-01':'2019-12-01', 'price'],
            label='observed')
axs[0].plot(f2019.index, f2019['predicted_mean'], color='r', label='sarimax')
axs[0].plot(f2019.index, f2019_rf, color='grey', label='random_forest')
...
f2020_rf = forecasts_rf['2020']

axs[1].plot(gold_data['2016-01-01':'2020-12-01'].index, gold_data.loc['2016-01-01':'2020-12-01', 'price'],
            label='observed')
axs[1].plot(f2020.index, f2020['predicted_mean'], color='r', label='sarimax')
axs[1].plot(f2020.index, f2020_rf, color='grey', label='random_forest')
...
f2021_rf = forecasts_rf['2021']

axs[2].plot(gold_data['2016-01-01':'2021-12-01'].index, gold_data.loc['2016-01-01':'2021-12-01', 'price'],
            label='observed')
axs[2].plot(f2021.index, f2021['predicted_mean'], color='r', label='sarimax')
axs[2].plot(f2021.index, f2021_rf, color='grey', label='random_forest')
